...
INSERT INTO recipes (name, cooking_time, rating) VALUES ('Pasta', '15' '2');
INSERT INTO recipes (name, cooking_time, rating) VALUES ('Sunday Roast', '120', '3');
...
recipes[0].cooking_time # =>  '15'
recipes[0].rating # =>  '2'

recipes[1].id # =>  2
recipes[1].name # =>  'Sunday Roast'
...
recipes.id # =>  1
recipes.name # =>  'Pasta'
recipes.cooking_time # =>  '15'
recipes.rating # =>  '2'

recipes = repo.find(2)

recipes.id # =>  2
recipes.name # =>  'Sunday Roast'
recipes.cooking_time # =>  '120'
recipes.rating # =>  '3'
